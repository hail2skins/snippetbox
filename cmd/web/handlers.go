...
import (
	...
	"github.com/hail2skins/snippetbox/internal/validator"
)
...
func (app *application) home(w http.ResponseWriter, r *http.Request) {
	...
	// Call the newTemplateData() and add the snippets to it:
...
func (app *application) snippetView(w http.ResponseWriter, r *http.Request) {
	...
	// Call the newTemplateData() helper and pass the snippet data to it.
	data := app.newTemplateData(r)
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	...
	// Add a flash message to the session to confirm log out.
	app.sessionManager.Put(r.Context(), "flash", "You've been logged out successfully!")

	// Redirect the user to the applicatio home page.
